...
\TODO{Maybe a graph for the real world models, that shows the runtime as precision for the iterative thing increases would be very cool. - Note, I tried this, and its a power law relationship too, but I'm not actually sure how interesting it is.}
